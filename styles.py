...
# --- DEFINICE BAREV PRO AKCE (Používáme RGBA pro průhlednost/Glass efekt) ---
BARVY_AKCI = {
...
def load_css():
    ...
    <style>
        ...
        h1 span.gradient-text {{
            ...
            font-weight: 800; /* Bold Exo 2 */
            text-shadow: 0 0 20px rgba(57, 255, 20, 0.3);
        }}

        /* === 4. UI PRVKY (Glassmorphism) === */
        /* Tlačítka */
        .stButton > button {{
